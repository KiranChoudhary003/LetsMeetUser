...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Example: catch any runtime errors globally in this component
    ...
    global.ErrorUtils.setGlobalHandler((e, isFatal) => {
      errorHandler(e);
      oldHandler(e, isFatal);
    });
  }, []);

  if (error) {
    // Show error on screen if any runtime error occurs
    return (
  ...
  return (
    <ScrollView contentContainerStyle={styles.center}>
      ...
      <Text style={styles.text}>Metro logging is working</Text>
      <Text style={styles.text}>Check the terminal for console.log messages</Text>
    </ScrollView>
  );
}
